...
<?php //include('head.html'); ?>
		<script class="include" type="text/javascript" src="js_cuentas/assets/js/jquery.dcjqaccordion.2.7.js"></script>
    <script type="text/javascript" src="js_cuentas/jquery-ui.js"></script>

		<!--script for this page
		script type="text/javascript" src="js_cuentas/assets/js/jquery1.7.1.js"></script>
		
		script type="text/javascript" src="js_cuentas/scripts/triggers.js"></script>-->
</head>
...
-->		
	...
	<script type="text/javascript" src="js_cuentas/app.js"></script>
	<script>
